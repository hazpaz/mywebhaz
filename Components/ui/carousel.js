...
var Carousel = React.forwardRef(function (_a, ref) {
    ...
    return value = {};
    {
        ...
        api,
            opts,
            orientation;
        orientation || ((opts === null || opts === void 0 ? void 0 : opts.axis) === "y" ? "vertical" : "horizontal"),
            scrollPrev,
            scrollNext,
            canScrollPrev,
            canScrollNext,
    ...
    >
        ref, { ref: ref }, onKeyDownCapture = { handleKeyDown: handleKeyDown }, className = {}, role = "region", aria - roledescription, "carousel", __assign({}, props) >
    { children: children }
    < /div>
...
var CarouselContent = React.forwardRef(function (_a, ref) {
    ...
    return ref = { carouselRef: carouselRef };
    className = "overflow-hidden" >
        ref;
    {
        ref;
    }
    className = { cn: function (, orientation) { } } === "horizontal" ? "-ml-4" : "-mt-4 flex-col",
        className;
});
...
var CarouselItem = React.forwardRef(function (_a, ref) {
    ...
    "slide";
    className = { cn: function (, orientation) { } } === "horizontal" ? "pl-4" : "pt-4",
        className;
});
...
var CarouselPrevious = React.forwardRef(function (_a, ref) {
    ...
    size = { size: size };
    className = { cn: function (, orientation) { } } === "horizontal"
